...
#[derive(Debug)]
pub struct NeoSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoSpectral processing");
    
    let mut processor = NeoSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoSpectralProcessor::new(false);
